...
const LocalWallet = (props) => {
    ...
    // @ts-ignore
    react_1.default.createElement(unlock_nep2_1.default, Object.assign({}, props))) : (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement(menu_1.default, { routes: routes }),
        react_1.default.createElement("div", { style: { minHeight: "300px" } }, routes.map((route) => {
